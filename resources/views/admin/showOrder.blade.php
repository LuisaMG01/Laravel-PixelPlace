...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-4">
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="1" class="py-4 px-2 font-semibold">User: </td>
                    <td></td>
                    <td></td>
    ...
    <a href="{{ route('admin.orders.index') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Go Back
    </a>
@endsection
