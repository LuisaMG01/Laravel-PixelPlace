            ...
            <div class='inline-block min-w-full align-middle'>
                <div class='overflow-hidden shadow'>
                    <table class='min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600'>
                        ...
                        <thead>
                            <tr>
                                <th class='px-4 py-2 text-sm font-bold text-gray-500 uppercase dark:text-gray-400'>Name</th>
                                <th class='px-4 py-2 text-sm font-bold text-gray-500 uppercase dark:text-gray-400'>Description</th>
                                <th class='px-4 py-2 text-sm font-bold text-gray-500 uppercase dark:text-gray-400'>Finished</th>
                                <th class='px-4 py-2 text-sm font-bold text-gray-500 uppercase dark:text-gray-400'>Reward Coins</th>
                                <th class='px-4 py-2 text-sm font-bold text-gray-500 uppercase dark:text-gray-400'>Max Users</th>
                                <th class='px-4 py-2 text-sm font-bold text-gray-500 uppercase dark:text-gray-400'>Current Users</th>
                                <th class='px-4 py-2 text-sm font-bold text-gray-500 uppercase dark:text-gray-400'>Expiration Date</th>
                                <th class='px-4 py-2 text-sm font-bold text-gray-500 uppercase dark:text-gray-400'>Category</th>
                                <th class='px-4 py-2 text-sm font-bold text-gray-500 uppercase dark:text-gray-400'>Product Quantity</th>
                            </tr>
                        </thead>
                            ...
                            @foreach($viewData['challenges'] as $challenge)
                                <tr class='hover:bg-gray-100 dark:hover:bg-gray-700'>
                                    <td class='px-4 py-2 text-sm font-normal text-gray-500 dark:text-gray-400'>
                                        <div class='text-base font-semibold text-gray-900 dark:text-white'>{{ $challenge -> getName() }}</div>
                                    </td>
                                    <td class='px-4 py-2 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white'>
                                        {{ $challenge -> getDescription() }}
                                    </td>
                                    <td class='max-w-sm px-4 py-2 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400'>
                                ...
                                <td class='p-4 space-x-2 whitespace-nowrap'>
                                    ...
                                    <button type='submit' id='deleteProductButton'
                                        ...
                                        aria-controls='drawer-delete-product-{{ $challenge->getId() }}' data-drawer-placement='right'
                                    ...
                                    <div id='drawer-update-product-{{ $challenge->getId() }}'
                                        ...
                                        <h5 id='drawer-label'
                                            ...
                                            Challenge</h5>
                                        <button type='button' data-drawer-dismiss='drawer-update-product-{{ $challenge->getId() }}'
                                        ...
                                        <form method='POST' action='{{ route('admin.challenges.update', ['id' => $challenge->getId()]) }}'>
                                            @csrf
                                            <div class='space-y-4'>
                                                <div>
                                                    ...
                                                    <input type='text' name='name' id='name' 
                                                        ...
                                                        placeholder='Type challenge name' value='{{ $challenge-> getName() }}'>
                                                </div>
                                                <div>
                                                    <label for='description' class='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Description</label>
                                                    <input type='text' name='description' id='description'
                                                        class='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500'
                                                        placeholder='Type description' value='{{ $challenge-> getDescription() }}'>
                                                </div>
                                                <div>
                                                    <label for='reward_coins' class='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Reward Coins</label>
                                                    <input type='number' name='reward_coins' id='reward_coins'
                                                        class='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500'
                                                        placeholder='Enter the reward coins' value='{{ $challenge-> getRewardCoins() }}'>
                                                </div>
                                                <div>
                                                    <label for='max_users' class='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Max Users</label>
                                                    <input type='number' name='max_users' id='max_users'
                                                        class='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500'
                                                        placeholder='Enter the top amount of users' value='{{ $challenge-> getMaxUsers() }}'>
                                                </div>
                                                <div>
                                                    ...
                                                    <select name='category_id' id='category_id'
                                                        ...
                                                        <option value='' disabled {{ $challenge->category->name === '' ? 'selected' : '' }}>Select category</option>
                                                        @foreach($viewData['categories'] as $category)
                                                            <option value='{{ $category->id }}' {{ $challenge->category->id === $category->id ? 'selected' : '' }}>
                                                                {{ $category->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div>
                                                    ...
                                                    <input type='date' name='expiration_date' id='expiration_date'
                                                        class='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500'
                                                        placeholder='Enter the expiration date' value='{{ $challenge-> getExpirationDate() }}'>
                                                </div>
                                                <div>
                                                    <label for='category_quantity' class='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Category Quantity</label>
                                                    <input type='number' name='category_quantity' id='category_quantity'
                                                        class='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500'
                                                        placeholder='Enter the amount of products' value='{{ $challenge-> getMaxUsers() }}'>
                                                </div>
                                                
                                            </div>
                                            <div class='flex justify-center mt-10'>
                                                <button type='submit' id='updateProductButton' data-drawer-target='drawer-update-product-{{ $challenge->getId() }}'
                                                    data-drawer-show='drawer-update-product-{{ $challenge->getId() }}' aria-controls='drawer-update-product-{{ $challenge->getId() }}'
                                    ...
                                    <div id='drawer-delete-product-{{ $challenge->getId() }}'
                                        ...
                                        <button type='submit' data-drawer-dismiss='drawer-delete-product-{{ $challenge->getId() }}'
