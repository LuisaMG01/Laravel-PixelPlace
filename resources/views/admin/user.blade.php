                ...
                @foreach ($users as $user)
                    <tr
                        ...
                        <td class="p-4 space-x-2 whitespace-nowrap">
                            <button type="button" id="updateUserButton"
                                ...
                                aria-controls="drawer-update-user-{{ $user->getId() }}" data-drawer-placement="right"
                            ...
                            <button type="button" id="deleteUserButton"
                                ...
                                aria-controls="drawer-delete-user-{{ $user->getId() }}" data-drawer-placement="right"
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="role-{{ $user->getId() }}" name="role"
                                        ...
                                        <option value="client" {{ $user->getRole() === 'client' ? 'selected' : '' }}>
                    ...
                    <div id="drawer-delete-user-{{ $user->getId() }}"
                        ...
                        <form id="delete-form-{{ $user->getId() }}"
                            action="{{ route('admin.users.destroy', ['id' => $user->getId()]) }}" method='POST'>
                            @csrf
                            @method('DELETE')
                            <button type="submit"
