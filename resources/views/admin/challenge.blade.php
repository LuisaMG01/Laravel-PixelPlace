                        ...
                        <tbody class='divide-y divide-gray-200 dark:divide-gray-700'>
                            @foreach ($viewData['challenges'] as $challenge)
                                ...
                                <div id='drawer-update-product-{{ $challenge->getId() }}'
                                    ...
                                    <form action='{{ route('admin.challenges.update', ['id' => $challenge->getId()]) }}'
                                        ...
                                        <div class='space-y-4'>
                                            <div>
                                                ...
                                                <input type='text' name='name' id='name'
                                                    ...
                                                    placeholder="{{ __('admin.name_placeholder_admin_challenge') }}">
                                            </div>
                                            <div>
                                                ...
                                                <input type='text' name='description' id='description'
                                                    ...
                                                    placeholder="{{ __('admin.description_placeholder_admin_challenge') }}">
                                            </div>
                                            <div>
                                                ...
                                                <input type='number' name='reward_coins' id='reward_coins'
                                                    ...
                                                    placeholder="{{ __('admin.reward_coins_placeholder_admin_challenge') }}">
                                            </div>
                                            <div>
                                                <label for='max_users'
                                                ...
                                                <input type='number' name='max_users' id='max_users'
                                                    ...
                                                    placeholder="{{ __('admin.amount_users_placeholder_admin_challenge') }}">
                                            </div>
                                            <div>
        ...
        <form method='POST' action='{{ route('admin.challenges.store') }}'>
            ...
            <div class='space-y-4'>
                ...
                <div>
                    ...
                    <input type='number' name='category_quantity' id='category_quantity'
                        class='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500'
                        placeholder="{{ __('admin.goal_quantity_placeholder_admin_challenge') }}">
                </div>
                <div class='flex justify-center mt-10'>
                    <button id='createProductButton'
                        ...
                        data-drawer-placement='right'>
                        {{ __('admin.goal_quantity_placeholder_admin_challenge') }}
                    </button>
                </div>
        </form>
    </div>
