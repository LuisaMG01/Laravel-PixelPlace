...
@section('content')
    ...
    <div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
        ...
        <!-- Image -->
        <form action="{{ route('user.update', ['id' => Auth::user()->getId()]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="col-span-full xl:col-auto">
                <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                    <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                        <img class="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0" src="{{ URL::asset('storage/' . Auth::user()->getName() . '.png') }}" alt="{{ Auth::user()->getName() }} picture">
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <input type="file" name="image" id="image"
                                    ...
                                    placeholder="Type product name" value="{{ URL::asset('storage/' . Auth::user()->getName() . '.png') }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <h3 class="mb-4 text-xl font-semibold dark:text-white">General information</h3>
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-full">
                                    <button class="py-2 px-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" type="submit">
                                        Save all
                                    </button>
                                </div>
                            </div>
