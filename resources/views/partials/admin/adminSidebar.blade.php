            ...
            <li>
                <a href='{{ route('admin.home.index') }}'
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap"
                        sidebar-toggle-item>{{ __('admin.sidebar_home') }}</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ route('admin.users.index') }}"
                    ...
                    <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        ...
                        <path d="M5 16C6.20831 13.4189 10.7122 13.2491 12 16" stroke="currentColor" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <path
                ...
                <a href="{{ route('admin.categories.index') }}"
                    ...
                    <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        ...
                        <path
                            ...
                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                        <path d="M11 17H9M9 17L7 17M9 17L9 19M9 17L9 15" stroke="currentColor" stroke-width="1.5"
