                            ...
                            <div class="inline-flex items-center">
                                <svg aria-hidden="true" class="h-3.5 w-3.5 rounded-full me-2"
                                    ...
                                    <g fill-rule="evenodd">
                                        ...
                                        <path fill="#F1BF00" d="M0 170.67h512v170.67H0z" />
                                    </g>
                                </svg>
            ...
            <ul
                ...
                <li>
                    <a href="{{ route('plant.index') }}"
                        class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{{ __('app.plants_navbar') }}</a>
                </li>
            </ul>
