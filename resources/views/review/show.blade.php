                                    ...
                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                        ...
                                        <li>
                                            <a href="{{ route('reviews.edit', ['id' => $review->getId()]) }}"
                                                class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{ __('edit_review_show') }}</a>
                                        </li>
                                        <li>
                                            <form action="{{ route('reviews.destroy', ['id' => $review->getId()]) }}"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{ __('delete_review_show') }}</button>
                                            </form>
                                        </li>
                                    </ul>
                                </div>
