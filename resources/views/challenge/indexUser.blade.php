...
<div class="flex justify-center items-center flex-col mb-4">
    ...
    <h3 class="mb-4 text-xl font-medium text-gray-500 dark:text-black-400">Browse the buttons to see your challenges</h3>
</div>
    ...
    <div class="challenge-group undone" style="display: none;">
        ...
        <h1 class="col-span-full text-center font-bold text-3xl text-blue-700 mt-8 mb-4">❌ Undone Challenges ❌</h1>
        </br>

        @if ($viewData['undoneChallenges']->isEmpty())
            <div id="initialImage" class="flex justify-center items-center flex-col mb-4">
                <h1 class="text-center font-bold mx-auto">You do not have undone challenges.</h1>
            </div>
        @endif   
        ...
        @foreach ($viewData['undoneChallenges'] as $challenge)
            <div class="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <p class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400">Description: {{ $challenge->getDescription() }}</p>
