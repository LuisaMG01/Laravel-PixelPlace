...
@section('content')
    ...
    <div id="done" class="challenge-group done">
        ...
        <h1 class="col-span-full text-center font-bold text-3xl text-blue-700 mt-8 mb-4">🏆
            {{ __('app.index_user_challenge_done_challenge_title') }} 🏆</h1>
        </br>
                ...
                <div
                    ...
                    <ul role="list" class="space-y-3 my-5">
                        ...
                        <li class="flex items-center">
                            ...
                            <span
                                class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">{{ __('app.index_user_challenge_expiration_date') }}
                                {{ $challenge->getExpirationDate() }}</span>
                        </li>
                        <li class="flex items-center">
                            <svg class="flex-shrink-0 w-4 h-4 text-blue-700 dark:text-blue-500" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <li class="flex items-center">
                            ...
                            <span
                                class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">{{ __('app.index_user_challenge_goal') }}
    ...
    <div id="progress" class="challenge-group in-progress">
        ...
        <h1 class="col-span-full text-center font-bold text-3xl text-blue-700 mt-8 mb-4">⌛
            {{ __('app.index_user_challenge_in_progress_challenge_title') }} ⌛</h1>
        </br>

        @if ($viewData['inProgressChallenges']->isEmpty())
            <div id="initialImage" class="flex justify-center items-center flex-col mb-4">
                <h1 class="text-center font-bold mx-auto">{{ __('app.index_user_challenge_not_in_progress_challenge') }}
                </h1>
            </div>
        @endif
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 justify-center"
